...
let datafolder = @"U:\Projects\featureBasedScheduling\Dati\FeatureExtractionResults"

// merge convolution files
//let csvfiles = System.IO.Directory.EnumerateFiles(datafolder, "FeatureExtractionResults.csv")
let csvfiles = System.IO.Directory.EnumerateFiles(datafolder, "Aggregated Data-Table 1.csv")
...
let alg = getColumn 26
let kernel_calls = getColumn 22

let discreteGPUTime = getColumn 23
let integratedGPUTime = getColumn 24
let CPUTime = getColumn 25
